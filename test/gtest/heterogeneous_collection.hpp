	...
	class HeterogeneousCollectionTest: public testing::Test
	{
	protected:
	  int Nloop_;
	  int Nvector_;
	...
	public:
	  ...
	  TEST_F(HeterogeneousCollectionTest, TestMlt)
	  {
	    Nloop_ = 10;
	    Nvector_ = 1000;
	    Nsub_vector_max_ = 10;
	  ...
	  TEST_F(HeterogeneousCollectionTest, TestAdd)
	  {
	    Nloop_ = 10;
	    Nvector_ = 1000;
	    Nsub_vector_max_ = 10;
	  ...
	  TEST_F(HeterogeneousCollectionTest, TestCopy)
	  {
	    Nloop_ = 1;
	    Nvector_ = 10;
	    Nsub_vector_max_ = 100;
	  ...
	  TEST_F(HeterogeneousCollectionTest, TestDotProduct)
	  {
	    Nloop_ = 10;
	    Nvector_ = 1000;
	    Nsub_vector_max_ = 10;
	  ...
	  TEST_F(HeterogeneousCollectionTest, TestMltAdd)
	  {
	    Nloop_ = 10;
	    Nvector_ = 1000;
	    Nsub_vector_max_ = 10;
