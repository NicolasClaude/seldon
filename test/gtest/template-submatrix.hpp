...
public:
  ...
  TEST_F(SubMatrixTest, TestConstructor)
    {
    ...
    Matrix<@real_complex, General, @storage_full_real_complex> M@storage_full_real_complex_@real_complex(m_, n_);
    {
      ...
      ASSERT_TRUE(SubM@storage_full_real_complex_@real_complex.GetM() == m_sub_);
      ASSERT_TRUE(SubM@storage_full_real_complex_@real_complex.GetN() == n_sub_);
    }
    ...
    Matrix<@complex, General, @storage_full_complex> M@storage_full_complex_@complex(m_, n_);
    {
      ...
      ASSERT_TRUE(SubM@storage_full_complex_@complex.GetM() == m_sub_);
      ASSERT_TRUE(SubM@storage_full_complex_@complex.GetN() == n_sub_);
    }
  }


  TEST_F(SubMatrixTest, TestAccess)
  {
...

    {
      ...
      for (int i = 0; i < m_; i++)
        for (int j = 0; j < n_; j++)
          {
            ASSERT_TRUE(SubM@storage_rectangular_full_@real_complex(i, j) == M@storage_rectangular_full_@real_complex(i, j));
          }
    }

    {
      ...
      for (int i = 0; i < m_; i++)
        for (int j = 0; j < n_; j++)
          {
            ASSERT_TRUE(SubM@storage_rectangular_sparse_@real(i, j) == M@storage_rectangular_sparse_@real(i, j));
          }
    }
...

    {
      ...
      for (int i = 0; i < m_sub_; i++)
        for (int j = 0; j < n_sub_; j++)
          {
            ASSERT_TRUE(SubM@storage_rectangular_full_@real_complex(i, j) == M@storage_rectangular_full_@real_complex(row_(i), column_(j)));
          }
    }

    {
      ...
      for (int i = 0; i < m_sub_; i++)
        for (int j = 0; j < n_sub_; j++)
          {
            ASSERT_TRUE(SubM@storage_rectangular_sparse_@real(i, j) == M@storage_rectangular_sparse_@real(row_(i), column_(j)));
          }
    }
